...
class CfgWeapons
{
    ...
    class KAT_Armor_Cooper : KAT_Armor__Base
	{
		...
		{
			"KAT_Armor\swordfish\Cooper\Reach_Armor_Upper_co.paa", // shoulders
			"", // unused
			"", // unused
			"KAT_Armor\swordfish\Cooper\Reach_Armor_Upper_co.paa", // upper
			"KAT_Armor\swordfish\Cooper\Reach_Armor_Lower_co.paa", // lower
			"" // unused
		};
    ...
    class KAT_Helmets_Cooper: KAT_Base_CQC_Helmet
	{
		...
		hiddenSelectionsTextures[] = {"KAT_Armor\swordfish\Cooper\cqc_helmet_co.paa","KAT_Armor\swordfish\Cooper\cqc_visor_co.paa"};
