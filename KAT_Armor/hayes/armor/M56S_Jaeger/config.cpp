class CfgPatches
{
    class KAT_M56S_Jaeger_Armor_Hayes
    {
        author = "wlan0";
        ...
        weapons[] =
        {
            "KAT_M56S_Jaeger_Armor_Hayes_Corpsman_Blue"
        };
    };
};
class CfgWeapons
{
    ...
    class KAT_M56S_Jaeger_Armor_Hayes_Corpsman_Blue : KAT_M56S_Jaeger_Armor_Rifleman
    {
        displayName = "[KAT] M56S/J Corpsman [Hayes][Blue]";
        hiddenSelections[] =
        {
        ...
        hiddenSelectionsTextures[] =
        {
            ...
            "KAT_Armor\hayes\armor\M56S_Jaeger\_textures\main_blue.paa"
        };
