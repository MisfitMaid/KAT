...
class CfgWeapons
{
    class MAPO_MP_Helmet;
    class KAT_Mjolnir_Helmet_A064 : MAPO_MP_Helmet
	{
		MJOLNIR_isHelmet=1;
		scope = 2;
		scopeArsenal = 2;
		author = "MisfitMaid";
		displayName = "[Azrael] Mjolnir Helmet A064";
		hiddenSelections[]=
		{
			"camo1",
			"camo2"
		...
		{
			"KAT_Mjolnir\A064-Odin\helmet.paa",
			"MA_Armor\data\helmets\mp\visors\gold_mp_visor_co.paa"
		};
	};

	class MAPO_MKVB_Armor;
	class KAT_Mjolnir_Vest_A064 : MAPO_MKVB_Armor
	{
		MJOLNIR_isArmor=1;
		scope = 2;
		scopeArsenal = 2;
		author = "MisfitMaid";
		displayName = "[Azrael] Mjolnir Armor A064";
		hiddenSelections[]=
		{
			"camo1",
			"camo2"
		...
		hiddenSelectionsTextures[]=
		{
			"KAT_Mjolnir\A064-Odin\upper.paa",
			"KAT_Mjolnir\A064-Odin\lower.paa"
		};
	};
};
...
class CfgVehicles
{
	...
	class KAT_Mjolnir_Shoulders_A064: Mjolnir_Gungnir_Shoulders_Spartan
	{
		scope=2;
		scopeArsenal=2;
		displayName="[Azrael] Mjolnir Shoulders A064";
		author = "MisfitMaid";
		...
		hiddenSelectionsTextures[]=
		{
			...
			"MA_Armor\data\Vests\MKVB\Shoulders\Grenadier\Olive_Grenadier_Shoulders_CO.paa",
			"KAT_Mjolnir\A064-Odin\shoulders.paa",
			"KAT_Mjolnir\A064-Odin\shoulders.paa",
