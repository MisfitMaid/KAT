...
class CfgWeapons
{
    ...
    class KAT_Mjolnir_Helmet_G258 : MAPO_MKV_Helmet
	{
		MJOLNIR_isHelmet=1;
		scope = 2;
		scopeArsenal = 2;
		displayName = "[Azrael] Mjolnir Helmet G258";
		hiddenSelections[]=
		{
			"camo1",
			"camo2"
		...
		{
			"MA_Armor\data\Helmets\MKV\helmets\black_mkv_helmet_co.paa",
			"MA_Armor\data\Helmets\MKV\visors\black_mkv_visor_co.paa"
		};
	};

	class MAPO_MKVB_Armor;
	class KAT_Mjolnir_Vest_G258 : MAPO_MKVB_Armor
	{
		MJOLNIR_isArmor=1;
		scope = 2;
		scopeArsenal = 2;
		displayName = "[Azrael] Mjolnir Armor G258";
		hiddenSelections[]=
		{
			"camo1",
			"camo2"
		...
		hiddenSelectionsTextures[]=
		{
			"MA_Armor\data\Vests\MKVB\color_variants\black_mkv_upper_co.paa",
			"MA_Armor\data\Vests\MKVB\color_variants\black_mkv_lower_co.paa"
		};
	};
};
...
class CfgVehicles
{
	...
	class KAT_Mjolnir_Shoulders_G258: Mjolnir_Recon_Shoulders_Spartan
	{
		scope=2;
		scopeArsenal=2;
		displayName="[Azrael] Mjolnir Shoulders G258";
		...
		hiddenSelectionsTextures[]=
		{
			...
			"MA_Armor\data\Vests\MKVB\Shoulders\JFO\Olive_JFO_Shoulders_CO.paa",
			"MA_Armor\data\Vests\MKIV\Color_Variants\Black_MKIV_Shoulders_CO.paa",
			"MA_Armor\data\Vests\MKIV\Color_Variants\Black_MKIV_Shoulders_CO.paa",
			...
			"MA_Armor\data\Vests\MKVB\Shoulders\Operator\Olive_Operator_Shoulders_CO.paa",
			"KAT_Mjolnir\G258-Tessa\shoulders.paa",
			"KAT_Mjolnir\G258-Tessa\shoulders.paa",
