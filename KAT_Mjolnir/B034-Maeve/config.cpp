...
class CfgWeapons
{
    ...
    class KAT_Mjolnir_Helmet_B034 : MAPO_MKV_Helmet
	{
		...
		scopeArsenal = 2;
		author = "MisfitMaid";
		displayName = "[Azrael] Mjolnir Helmet B034";
		hiddenSelections[]=
		{
			"camo1",
			"camo2"
		...
		{
			"KAT_Mjolnir\B034-Maeve\helmet.paa",
	...
	class KAT_Mjolnir_Vest_B034 : MAPO_MKVB_Armor
	{
		...
		scopeArsenal = 2;
		author = "MisfitMaid";
		displayName = "[Azrael] Mjolnir Armor B034";
		hiddenSelections[]=
		{
			"camo1",
			"camo2"
		...
		hiddenSelectionsTextures[]=
		{
			"KAT_Mjolnir\B034-Maeve\armor_upper.paa",
			"KAT_Mjolnir\B034-Maeve\armor_lower.paa"
		};
	};
};
...
class CfgVehicles
{
	class Mjolnir_Scout_Shoulders_Spartan;
	class KAT_Mjolnir_Shoulders_B034: Mjolnir_Scout_Shoulders_Spartan
	{
		scope=2;
		scopeArsenal=2;
		displayName="[Azrael] Mjolnir Shoulders B034";
		author = "MisfitMaid";
		...
		hiddenSelectionsTextures[]=
		{
			...
			"MA_Armor\data\Vests\MKVB\Shoulders\Security\Olive_Security_Shoulders_CO.paa",
			"KAT_Mjolnir\B034-Maeve\shoulders.paa",
			"KAT_Mjolnir\B034-Maeve\shoulders.paa"
		};
	};
};
